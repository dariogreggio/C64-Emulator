...
void Adafruit_GFX(UGRAPH_COORD_T w, UGRAPH_COORD_T h); // Constructor
  ...
  void gfx_drawLine(UGRAPH_COORD_T x0, UGRAPH_COORD_T y0, UGRAPH_COORD_T x1, UGRAPH_COORD_T y1, GFX_COLOR color);
  void gfx_drawFastVLine(UGRAPH_COORD_T x, UGRAPH_COORD_T y, UGRAPH_COORD_T h, GFX_COLOR color);
  void gfx_drawFastHLine(UGRAPH_COORD_T x, UGRAPH_COORD_T y, UGRAPH_COORD_T w, GFX_COLOR color);
  void gfx_drawRect(UGRAPH_COORD_T x, UGRAPH_COORD_T y, UGRAPH_COORD_T w, UGRAPH_COORD_T h, GFX_COLOR color);
  void gfx_fillRect(UGRAPH_COORD_T x, UGRAPH_COORD_T y, UGRAPH_COORD_T w, UGRAPH_COORD_T h, GFX_COLOR color);
...
#define gfx_invertDisplay(i) invertDisplay(i)
  ...
  void drawCircleHelper(UGRAPH_COORD_T x0, UGRAPH_COORD_T y0, UGRAPH_COORD_T r, UINT8 cornername, GFX_COLOR color);
  void fillCircle(UGRAPH_COORD_T x0, UGRAPH_COORD_T y0, UGRAPH_COORD_T r, GFX_COLOR color);
  void fillCircleHelper(UGRAPH_COORD_T x0, UGRAPH_COORD_T y0, UGRAPH_COORD_T r, UINT8 cornername, GRAPH_COORD_T delta, GFX_COLOR color);
  void drawTriangle(UGRAPH_COORD_T x0, UGRAPH_COORD_T y0, UGRAPH_COORD_T x1, UGRAPH_COORD_T y1, UGRAPH_COORD_T x2, UGRAPH_COORD_T y2, GFX_COLOR color);
  void fillTriangle(UGRAPH_COORD_T x0, UGRAPH_COORD_T y0, UGRAPH_COORD_T x1, UGRAPH_COORD_T y1, UGRAPH_COORD_T x2, UGRAPH_COORD_T y2, GFX_COLOR color);
  void drawRoundRect(UGRAPH_COORD_T x0, UGRAPH_COORD_T y0, UGRAPH_COORD_T w, UGRAPH_COORD_T h, UGRAPH_COORD_T radius, GFX_COLOR color);
  void fillRoundRect(UGRAPH_COORD_T x0, UGRAPH_COORD_T y0, UGRAPH_COORD_T w, UGRAPH_COORD_T h, UGRAPH_COORD_T radius, GFX_COLOR color);
  void drawBitmap(UGRAPH_COORD_T x, UGRAPH_COORD_T y, const UINT8 *bitmap, UGRAPH_COORD_T w, UGRAPH_COORD_T h, GFX_COLOR color);
  void drawBitmapBG(UGRAPH_COORD_T x, UGRAPH_COORD_T y, const UINT8 *bitmap, UGRAPH_COORD_T w, UGRAPH_COORD_T h, GFX_COLOR color, GFX_COLOR bg);
#ifdef RAM_BITMAP
  void drawBitmap3(UGRAPH_COORD_T x, UGRAPH_COORD_T y, UINT8 *bitmap, UGRAPH_COORD_T w, UGRAPH_COORD_T h, GFX_COLOR color);
  void drawBitmap4(UGRAPH_COORD_T x, UGRAPH_COORD_T y, UINT8 *bitmap, UGRAPH_COORD_T w, UGRAPH_COORD_T h, GFX_COLOR color, GFX_COLOR bg);
  void drawXBitmap(UGRAPH_COORD_T x, UGRAPH_COORD_T y, const UINT8 *bitmap, UGRAPH_COORD_T w, UGRAPH_COORD_T h, GFX_COLOR color);
#endif
  void drawChar(UGRAPH_COORD_T x, UGRAPH_COORD_T y, unsigned char c, GFX_COLOR color, GFX_COLOR bg, UINT8 size);
  void setTextColor(GFX_COLOR c);
  void setTextColorBG(GFX_COLOR c, GFX_COLOR bg);
  ...
  extern UGRAPH_COORD_T  _width, _height, // Display w/h as modified by current rotation
    cursor_x, cursor_y;
  extern GFX_COLOR  textcolor, textbgcolor;
  ...
  void initButton(ADAFRUIT_GFX gfx, UGRAPH_COORD_T x, UGRAPH_COORD_T y, UINT8 w, UINT8 h, GFX_COLOR outline, GFX_COLOR fill,
    GFX_COLOR textcolor, char *label, UINT8 textsize);
  ...
  extern GFX_COLOR _outlinecolor, _fillcolor, _textcolor;
...
// questo pure era dinamico ma lo rendo ovviamente statico
  ...
  void drawPixel1(UGRAPH_COORD_T x, UGRAPH_COORD_T y, GFX_COLOR color);
  void fillScreen1(GFX_COLOR color);


  void GFXcanvas16(UGRAPH_COORD_T w, UGRAPH_COORD_T h);
  void delete_GFXcanvas16(void);
  void drawPixel16(UGRAPH_COORD_T x, UGRAPH_COORD_T y, GFX_COLOR color);
  void fillScreen16(GFX_COLOR color);
  GFX_COLOR *getBuffer16(void);

  GFX_COLOR *gfx_buffer16;
